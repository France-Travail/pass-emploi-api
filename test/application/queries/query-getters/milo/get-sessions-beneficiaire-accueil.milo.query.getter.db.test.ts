...
describe('GetSessionsBeneficiaireAccueilMiloQueryGetter', () => {
  let getter: GetSessionsBeneficiaireAccueilMiloQueryGetter
  ...
  beforeEach(async () => {
    ...
    getter = new GetSessionsBeneficiaireAccueilMiloQueryGetter(fetcher)
