...
import { DesarchiverJeuneCommandHandler } from './application/commands/support/desarchiver-jeune.command.handler.db'
...
import { GenerateurPlanActionLlm } from './infrastructure/plan-action/generateur-plan-action-llm'
import {
...
import { GetSessionsVisiblesOuInscritesPourLeJeuneMiloQueryGetter } from './application/queries/query-getters/milo/get-sessions-visibles-ou-inscrites-pour-jeune.milo.query.getter.db'
...
export const buildModuleMetadata = (): ModuleMetadata => ({
  ...
  providers: [
    ...
    {
      provide: PlanActionGenerateurToken,
      useClass: GenerateurPlanActionLlm
    },
    {
      provide: APP_GUARD,
