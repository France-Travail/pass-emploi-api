...
import { filtreStructureEtDispositifs } from '../../infrastructure/sequelize/filtre-structures-dispositifs'
import {
  Notification,
...
async function recupererBeneficiairesANotifier(
  ...
  return await JeuneSqlModel.findAndCountAll({
    where: {
      ...filtreStructureEtDispositifs(DISPOSITIFS_FT_HORS_AVENIR_PRO),
