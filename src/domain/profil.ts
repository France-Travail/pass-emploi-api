...
export interface StructureEtDispositifs {
  structure: Profil.Structure
  dispositifs?: readonly Profil.Dispositif[]
}

export const TOUT_MILO: StructureEtDispositifs = {
  structure: Profil.Structure.MILO
}
export const TOUT_FRANCE_TRAVAIL: StructureEtDispositifs = {
  structure: Profil.Structure.FRANCE_TRAVAIL
}
export const TOUT_CONSEIL_DEPARTEMENTAL: StructureEtDispositifs = {
  structure: Profil.Structure.CONSEIL_DEPARTEMENTAL
}
export const TOUT_INVITE: StructureEtDispositifs = {
  structure: Profil.Structure.INVITE
}

export const DISPOSITIFS_FT_ACCOMPAGNES: StructureEtDispositifs = {
  structure: Profil.Structure.FRANCE_TRAVAIL,
  dispositifs: [
...
export const DISPOSITIFS_FT_AVEC_DEMARCHES: StructureEtDispositifs = {
  structure: Profil.Structure.FRANCE_TRAVAIL,
  dispositifs: [
...
export const DISPOSITIFS_ACCOMPAGNES: readonly StructureEtDispositifs[] = [
  TOUT_MILO,
...
export function profilEstAutorise(
  profil: Profil,
  profilsAutorises: readonly StructureEtDispositifs[]
): boolean {
...
export const DISPOSITIFS_FT_HORS_AVENIR_PRO: StructureEtDispositifs = {
  structure: Profil.Structure.FRANCE_TRAVAIL,
...
export const PROFILS_ALTERNANCE_ET_SERVICE_CIVIQUE: readonly StructureEtDispositifs[] =
  [
    TOUT_MILO,
    {
      structure: Profil.Structure.FRANCE_TRAVAIL,
...
export const PROFILS_CAMPAGNES: readonly StructureEtDispositifs[] = [
  TOUT_MILO,
  {
    structure: Profil.Structure.FRANCE_TRAVAIL,
    dispositifs: [
...
export function profilExact(profil: Profil): StructureEtDispositifs {
...
export function verifierProfils(
  profilsAutorises: StructureEtDispositifs | readonly StructureEtDispositifs[],
